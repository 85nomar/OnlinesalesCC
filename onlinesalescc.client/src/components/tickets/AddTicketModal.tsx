...
function AddTicketModal({
  ...
  const renderOrderForm = useCallback(() => {
    // Function to handle loading existing tickets
    const handleLoadTickets = (orderNumber: number) => {
  ...
  }, [artikelNr, bestellNr, loadExistingTicketsByOrder, onClose, onSuccess, resetFormValues]);
